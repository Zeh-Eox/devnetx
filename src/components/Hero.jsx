      ...
      >
        <div className="hero-content text-center">
          <div className="max-w-6xl flex flex-col items-center justify-center gap-6 p-4">
            ...
            <a
              href="#contact"
              className="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 md:py-4 px-4 border border-blue-500 hover:border-transparent rounded flex items-center gap-2"
            >
